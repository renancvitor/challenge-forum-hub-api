...
Para ver a interface Swagger em ação, acesse as [demonstrações visuais](./docs/swagger-demonstration.md) com GIFs interativos mostrando os principais endpoints da API.
